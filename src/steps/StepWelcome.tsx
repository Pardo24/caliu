    ...
    <div className="h-full flex flex-col items-center justify-center gap-8 px-8 text-center relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-4 relative z-10">
        <div className="logo-circle" style={{ padding: 6 }}>
          <img src={appIcon} alt="Moss" style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: 10 }} />
        </div>
        <div>
          <h1 className="text-5xl font-bold tracking-tight gradient-title">Moss</h1>
